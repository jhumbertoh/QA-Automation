  ...
  Feature: Adopting puppies
    ...
    Scenario: Adopting one puppy
      ...
      When I click the View Details button of the Puppy "Hanna"
    ...
    Scenario Outline: Adopting one puppys
      Given I am on the puppy adoption site
      #When I click the View Details button
      When I click the View Details button of the Puppy "Brook"
      And I click the Adopt Me button
      And I click the Complete the Adoption button
    ...
    Scenario: Adopting two puppies
      ...
      And I click the View Details button of the Puppy "Hanna"
    ...
    Scenario: Validate cart with two puppies
      Given I am on the puppy adoption site
      And I click the View Details button of the Puppy "Brook"
      And I click the Adopt Me button
      And I click the Adopt Another Puppy button
      And I click the View Details button of the Puppy "Hanna"
      And I click the Adopt Me button
    ...
    Scenario: Adopting a puppy using table
      Given I am on the puppy adoption site
      When I click the View Details button of the Puppy "Brook"
      And I click the Adopt Me button
      And I click the Complete the Adoption button
    ...
    Scenario: Name is a requiered field
      Given I am on the puppy adoption site
      When I click the View Details button of the Puppy "Brook"
      And I click the Adopt Me button
      And I click the Complete the Adoption button
      And I checkout leaving the name field blank
